...
var VRButton = {
	...
	createButton: function ( renderer, options ) {
        ...
        session.addEventListener('selectstart', (e) => {
          ...
          console.log(e);
          console.log(e.inputSource.gamepad.buttons);
          console.log(e.frame.getPose(e.inputSource.targetRaySpace, renderer.xr.getReferenceSpace()));
          //console.log(e.frame.getPose());
        });
